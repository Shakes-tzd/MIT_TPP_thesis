...
\begin{enumerate}
  ...
  \item How can regional monitoring be expanded and atmospheric models leveraged to inform action on the ground, particularly in regions with more ASGM emissions?
\end{enumerate}
\end{flushleft}
