...
\begin{figure}[H]
  ...
  \centering
  \caption{Bar chart showing the GMA 2018 ASGM Hg\textsuperscript{0} emission estimates for all countries in the world that have estimated ASGM Hg\textsuperscript{0} emissions above 1 Mg. The red bars indicate countries in Latin or South America }
