...
\begin{figure}[H]
\includegraphics[width=0.8\textwidth]{templates/figures/GMOS_Sites/GMOS_Sites.pdf}
\centering
...
\begin{flushleft}
 The comparison between the modelled concentration in the atmosphere and the PAS data corroborated the finding that the GEOS-Chem model overestimated the observed concentrations in the atmosphere as seen on Figure \ref{fig:Passive Samplers vs GC}. Moreover the PAS observations show high variability between the south and northern locations in South America while the modeled concentrations have a low concentration. 
\end{flushleft}
...
\begin{figure}[H]
  \includegraphics[width=0.7\textwidth]{templates/figures/Passive_Samplers/Passive Sampler vs Model.pdf}
